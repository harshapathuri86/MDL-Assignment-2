# https://github.com/mallika2011/Machine-Data-Learning/blob/master/A2-2/submission/task_1.py
import numpy as np
import os
import sys
...
def check(health1, arrows1, stamina1, health2, arrows2, stamina2, dh, da, ds):
    if (
        (dh == health1 - health2)
        and (da == arrows1 - arrows2)
        and (ds == stamina1 - stamina2)
    ):
        return 1
    else:
        return 0
                            ...
                            for a2 in range(0, arrows):
                                for s2 in range(0, stamina):
                                    ...
                                    temp += round(
                                        ...
                                        * (reward + gamma * utilities[h2, a2, s2]),
                                        11,
                                    )
